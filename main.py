...
from bot import startdriver, translatewhole
...
parser.add_argument(
    "--nowrite", action="store_true", help="disabled storing translated chapters"
)
parser.add_argument(
...
parser.add_argument(
    "--noreplace",
    action="store_true",
    help="disables replacing text using translation regex",
)
